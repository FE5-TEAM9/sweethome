  ...
  return (
    ...
    <section className={styles.cart_product_list}>
      ...
      <div className={styles.cart_product_wrap}>
        <div className={styles.cart_product_image}>
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQmUA3Z58_o6YhADl9AFdQN-wMvKbIrGGfrw&usqp=CAU"
           alt="product-img" />
        </div>
      ...
      <div className={styles.product_remove}>
        <img src="https://svgsilh.com/svg/150831.svg" alt="delete" />
      </div>
    </section>
    <div className={styles.total}>
      ...
      <div className={styles.pay_minus}>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhIoAupYzd1JbO027ohlPps9B9gjD34rAUlA&usqp=CAU" alt="minus" />
      </div>
